                ...
                child: Form(
                  ...
                  child: ListView(
                    children: [
                                            ...
                                            Text('Hotel Preference',
                                                style: TextStyle(
                                                    fontWeight:
                                                        FontWeight.bold)),
                                            TextFormField(
                                              controller: _hotelController,autovalidateMode:
                                                                    AutovalidateMode
                                                                        .onUserInteraction,
                                                                validator:
                                                                    _validateRequired,
                                              decoration: InputDecoration(
                                                  hintText: 'Hotel Preference',
                                                  hintStyle: TextStyle(
                                                      color: Color.fromARGB(
                                                          255, 1, 75, 148)),
                                            ...
                                            Text('City',
                                                style: TextStyle(
                                                    fontWeight:
                                                        FontWeight.bold)),
                                            TextFormField(
                                              controller: _cityController,autovalidateMode:
                                                                    AutovalidateMode
                                                                        .onUserInteraction,
                                                                validator:
                                                                    _validateRequired,
                                          ...
                                          children: [
                                            ...
                                            Stack(
                                              children: [
                                                TextFormField(
                                                  controller:
                                                      _checkinController,autovalidateMode:
                                                                    AutovalidateMode
                                                                        .onUserInteraction,
                                                                validator:
                                                                    _validateRequired,
                                          ...
                                          children: [
                                            ...
                                            Stack(
                                              children: [
                                                TextFormField(
                                                    controller:
                                                        _checkoutController,autovalidateMode:
                                                                    AutovalidateMode
                                                                        .onUserInteraction,
                                                                validator:
                                                                    _validateRequired,
                                            ...
                                            Text('No of People',
                                                style: TextStyle(
                                                    fontWeight:
                                                        FontWeight.bold)),
                                            TextFormField(
                                              controller: _peopleController,autovalidateMode:
                                                                    AutovalidateMode
                                                                        .onUserInteraction,
                                                                validator:
                                                                    _validateRequired,
                                              ...
                                              Text('Remarks',
                                                  style: TextStyle(
                                                      fontWeight:
                                                          FontWeight.bold)),
                                              TextFormField(
                                                controller: _remarksController,autovalidateMode:
                                                                    AutovalidateMode
                                                                        .onUserInteraction,
                                                                validator:
                                                                    _validateRequired,
                      ...
                      TextButton(
                          onPressed: () {
                            if (formkey.currentState!.validate()&&_accomodationController.text!=''&&_occupancyController.text!=''&&_peopleController.text!='') {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (_) => AccomTravelAdvance(data: {
                                            'accomodation':
                                                _accomodationController.text,
                                            'occupancy':
                                                _occupancyController.text,
