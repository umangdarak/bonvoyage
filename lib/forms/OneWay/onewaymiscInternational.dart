...
class OneWayMiscInternational extends StatefulWidget {
  bool? isInternational;
  OneWayModelInternational? model;
  OneWayMiscInternational({super.key, this.isInternational, this.model});

  @override
  State<OneWayMiscInternational> createState() =>
      _OneWayMiscInternationalState();
}

class _OneWayMiscInternationalState extends State<OneWayMiscInternational> {
 ...
 List<TextEditingController> currencymode =
  ...
  late OneWayModelInternational model;
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                ...
                Navigator.pop(
                    ...
                    MaterialPageRoute(
                        builder: (_) => OneWay(
                              ...
                              modelpassedinternational: widget.model,
                            )));
              },
        ...
        body: SingleChildScrollView(
          physics:
              AlwaysScrollableScrollPhysics(), // Ensures that SingleChildScrollView can always scroll
                                                                ...
                                                                TextFormField(
                                                                    ...
                                                                    onTap:
                                                                      ...
                                                                      if (pickeddate !=
                                                                        ...
                                                                        setState(
                                                                            () {
                                                                          _insurancevaliddateController.text =
                                        ...
                                        onPressed: () async {
                                          if (formkey.currentState!
                                            ...
                                            setState(() {
                                              ...
                                              model.currency= getTextFromControllers(currency);
                                              model.amount=getTextFromControllers(amount);
                                              ...
                                              model.insuranceavailability =
                                                  _insuranceavailableController
                                                      .text;
                                              model.insurancefromdate =
                                                  _insurancefromdateController
                                                      .text;
                                              model.insurancetodate =
                                                  _insurancetodateController
                                                      .text;
                                              model.insurancerequired =
                                                  _insurancerequiredController
                                                      .text;
                                              model.insurancename =
